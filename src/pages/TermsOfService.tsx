                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-6 text-muted text-base leading-relaxed">
                        <div className="space-y-3">
                            <h2 className="text-xl font-bold text-fg">1. Acceptance of Terms</h2>
                            <p>
                        ...
                        <div className="space-y-3">
                            <h2 className="text-xl font-bold text-fg">2. Use License</h2>
                            <p>
                        ...
                        <div className="space-y-3">
                            <h2 className="text-xl font-bold text-fg">3. Disclaimer</h2>
                            <p>
                        ...
                        <div className="space-y-3">
                            <h2 className="text-xl font-bold text-fg">4. Limitations</h2>
                            <p>
                        ...
                        <div className="space-y-3">
                            <h2 className="text-xl font-bold text-fg">5. Contact Information</h2>
                            <p>
