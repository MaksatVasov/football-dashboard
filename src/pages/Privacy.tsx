        ...
        <main className="w-full lg:max-w-5xl mx-auto min-h-screen bg-surface rounded-none lg:rounded-2xl mt-0 lg:mt-6 mb-10 pb-16 shadow-sm border border-transparent lg:border-line">
            <div className="w-full mx-auto px-6 pt-8 lg:px-12 lg:pt-12 animate-in fade-in duration-300">
                ...
                <div className="flex flex-col gap-6">
                    <span className="text-sm font-extrabold text-accent uppercase tracking-wider bg-accent/10 px-3 py-1 rounded-full w-fit">
                        Legal
                    </span>
                    ...
                    <div className="h-px w-full bg-line my-2"></div>

                    <div className="flex flex-col gap-6 text-muted text-base leading-relaxed">
                        <div className="space-y-3">
                            <h2 className="text-xl font-bold text-fg">1. Information We Collect</h2>
                            <p>
                        ...
                        <div className="space-y-3">
                            <h2 className="text-xl font-bold text-fg">2. How We Use Collected Information</h2>
                            <p>
                        ...
                        <div className="space-y-3">
                            <h2 className="text-xl font-bold text-fg">3. Protection of Your Information</h2>
                            <p>
                        ...
                        <div className="space-y-3">
                            <h2 className="text-xl font-bold text-fg">4. Sharing Your Personal Information</h2>
                            <p>
                        ...
                        <div className="space-y-3">
                            <h2 className="text-xl font-bold text-fg">5. Changes to This Privacy Policy</h2>
                            <p>
